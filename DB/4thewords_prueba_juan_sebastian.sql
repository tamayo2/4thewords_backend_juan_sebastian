...
-- Crear la tabla 'leyendas' si no existe
...
VALUES
    ...
    'El Cadejos es un perro espectral que aparece en las noches para asustar a los borrachos y guiar a las personas perdidas.',
    'https://wallpapercave.com/wp/wp6074813.jpg', '1880-01-01 00:00:00', 'San José', 'Central', 'San José'),

    ('El Cuijen y la Pelona', 'Leyenda Costarricense',
    'El Cuijen es un animal mitológico que vive en el monte y la Pelona es la muerte personificada que se aparece para llevarse a las almas.',
    'https://artfiles.alphacoders.com/146/thumb-1920-146789.jpg', '1700-01-01 00:00:00', 'Alajuela', 'San Carlos', 'Florencia'),

    ('El Diablo Chingo', 'Leyenda Costarricense',
    'El Diablo Chingo es una figura demoníaca que se aparece en caminos solitarios, creando caos y confundiendo a los viajeros.',
    'https://artfiles.alphacoders.com/424/thumb-1920-42490.jpg', '1900-01-01 00:00:00', 'Puntarenas', 'Central', 'Puntarenas'),
    ...
    'https://picfiles.alphacoders.com/465/thumb-1920-465252.jpg', '1800-01-01 00:00:00', 'Cartago', 'Turrialba', 'Turrialba'),
    ...
    'https://images6.alphacoders.com/135/thumb-1920-1352224.jpeg', '1850-01-01 00:00:00', 'Heredia', 'Barva', 'Barva'),

    ('El Padre sin Cabeza', 'Leyenda Costarricense',
    'Un sacerdote que fue asesinado y cuya cabeza nunca apareció. Se dice que su espíritu aún vaga por las noches buscando venganza.',
    ...
    'El Sisimiqui es un ser mítico que se dice habita en las montañas y actúa como guardián, protegiendo las tierras y las personas de intrusos.',
    ...
    'https://images5.alphacoders.com/133/thumb-1920-1337139.png', '1850-01-01 00:00:00', 'San José', 'Central', 'San José'),
